...
<<Fig_WTC_Extr_Phosphate_Temp, echo=FALSE, fig.height=3, fig.width=6>>=
TrtFg[[3]]
@
...
<<Stat_WTC_Extr_Phosphate_Smmry, echo=TRUE, results='markup'>>=
@
...
<<Fig_WTC_Extr_Phosphate_Chamber, echo=FALSE, fig.height=3, fig.width=6>>=
ChFg[[3]]
@
